...
class VideoDownloadInfo(BaseModel):
    ...
    video_id: Optional[str] = Field(default=None, description="抖音视频 ID")
    ...
    usage_tip: Optional[str] = Field(default=None, description="使用说明")
...
class DownloadResult(BaseModel):
    ...
    path: Optional[str] = Field(default=None, description="本地保存物理路径")
...
class AudioResult(BaseModel):
    ...
    message: str = Field(..., description="提示消息")
    title: Optional[str] = Field(default=None, description="标题")
    path: Optional[str] = Field(default=None, description="本地音频物理路径")
    error: Optional[str] = Field(default=None, description="错误详情")
...
class TextExtractionResult(BaseModel):
    status: str = Field(..., description="状态")
    text: Optional[str] = Field(default=None, description="提取的文本内容")
    title: Optional[str] = Field(default=None, description="视频标题")
    error: Optional[str] = Field(default=None, description="错误详情")

class AlbumImage(BaseModel):
    url: str = Field(..., description="图片下载链接")
    uri: Optional[str] = Field(default=None, description="图片 ID/URI")

class AlbumDownloadResult(BaseModel):
    status: str = Field(..., description="状态")
    message: str = Field(..., description="提示消息")
    video_id: Optional[str] = Field(default=None, description="作品 ID")
    title: Optional[str] = Field(default=None, description="标题")
...
class AwemeItem(BaseModel):
    ...
    url: Optional[str] = Field(default=None, description="下载链接或预览图链接")
...
class UserVideoList(BaseModel):
    ...
    cursor: int = Field(default=0, description="下一页游标")
    error: Optional[str] = Field(default=None, description="错误详情")
